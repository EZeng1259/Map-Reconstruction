...
public class FinishedClick : MonoBehaviour {
    ...
    public void RecordLocations(){
        ...
        string[] objNames;
        objNames = new string[19]{ "Gym", "Hardware Store", "Music Store", "Pharmacy",  "Bakery", "Bank", "Dentist", "Cafe", "Jewelery Store", "Butcher Store", "Grocery Store",
        ...
        string filePath = Application.streamingAssetsPath + "/StreamingAssets/MapData/coordinatesList_" + PlayerID.id + ".csv";
        //after your loop
